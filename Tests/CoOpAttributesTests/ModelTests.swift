...
//    }
    ...
    @NSManaged public var body: CoOpMutableStringAttribute?
    @NSManaged public var title: CoOpMutableStringAttribute?
}
...
let testModelDescription = CoreDataModelDescription(
    entities: [
        .entity(
            ...
            relationships: [
                .relationship(name: "body", destination: "CoOpMutableStringAttribute", optional: true, toMany: false),
                .relationship(name: "title", destination: "CoOpMutableStringAttribute", optional: true, toMany: false),
            ],
            indexes: []
        )
    ]
